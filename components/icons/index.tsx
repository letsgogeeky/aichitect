// All icon components used across the app.
// Each accepts an optional `size` prop (default 16) — pass explicitly when a different size is needed.
...
export function IconSettings2({ size = 16 }: { size?: number }) {
  return (
    <svg
      width={size}
      height={size}
...
export function IconGenome({ size = 16 }: { size?: number }) {
  return (
    <svg
      width={size}
      height={size}
...
export function IconTour({ size = 16 }: { size?: number }) {
  return (
    <svg
      width={size}
      height={size}
